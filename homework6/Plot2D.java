...
{ 
    ...
    public Plot2D()
    {
       ...
       //Make the arraylist that will be used in plot()
       this.path = new ArrayList<GeneralPath>();
    }
    ...
    public void plot(Function2D f)
    {
       ...
       GeneralPath currentPath = new GeneralPath(GeneralPath.WIND_EVEN_ODD, numPoints);
       currentPath.moveTo(scale*0, scale*(maxY-f.eval(minX)));
       ...
       while (current <= maxX)
       {
          ...
          currentPath.lineTo(scale*(current-minX), scale*(maxY-yValue));
       }

       //add the current path to the arraylist that will be painted
    ...
    public void paint(Graphics g)
    {
       ...
       // draw the path in red for each function
       g.setColor(Color.RED);
       for (GeneralPath i : this.path)
       {
	   g2.draw(i);
       }
